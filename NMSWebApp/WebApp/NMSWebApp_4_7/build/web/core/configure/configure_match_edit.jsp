                        ...
                        <div class="post">
                            <div class="post-body">
                                <div class="post-inner article" id="sys" >
                                    <h2 class="postheader">Match Edit</h2>
                                    <div class="cleared"></div>
                                    <div class="postcontent">
                                      <ul><form action="ConfigureMatch" method="post">
                                          <% 
                                              ...
                                              HostService  hostservice = (HostService)request.getAttribute("hostservice");
                                          %>
                                        <li>
                                            <table>
                                                ...
                                                <td><input  name="thd_value" type="text" size="30" value=<%=hostservice.getTh_value() %> /></td></tr> 
                                                <tr><td>Service's Timeout Value:  </td>
                                                <td><input  name="timeout_value" type="text" size="30" value=<%=hostservice.getTimeout() %> /></td></tr> 
                                            </table></li> 
                                            <input  hidden name="hostservice_id" type="text" value=<%=hostservice.getId() %>   />
                                            <input hidden type="text" name="host_id" value=<%= host.getId()  %> /> 
                                            <input hidden type="text" name="service_id" value=<%= serv.getId()  %> /> 
                                        <input name="hostservice_edited" type="submit" value="Apply"/>
                                      </form>
                                        </ul>
                                    </div>
                                    <div class="cleared"></div>
